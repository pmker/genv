...
import (
	...
	"github.com/pmker/genv/pkg/processor/config"
	"github.com/pmker/genv/pkg/processor/healthcheck"
	"github.com/pmker/genv/pkg/processor/metricsink"
	"github.com/pmker/genv/pkg/processor/runtime"
	// load all runtimes
	_ "github.com/pmker/genv/pkg/processor/runtime/dotnetcore"
	_ "github.com/pmker/genv/pkg/processor/runtime/golang"
	_ "github.com/pmker/genv/pkg/processor/runtime/java"
	_ "github.com/pmker/genv/pkg/processor/runtime/nodejs"
	_ "github.com/pmker/genv/pkg/processor/runtime/python"
	_ "github.com/pmker/genv/pkg/processor/runtime/ruby"
	_ "github.com/pmker/genv/pkg/processor/runtime/shell"
	"github.com/pmker/genv/pkg/processor/status"
	"github.com/pmker/genv/pkg/processor/trigger"
	// load all triggers
	_ "github.com/pmker/genv/pkg/processor/trigger/cron"
	_ "github.com/pmker/genv/pkg/processor/trigger/http"
	_ "github.com/pmker/genv/pkg/processor/trigger/kafka"
	_ "github.com/pmker/genv/pkg/processor/trigger/kickstart"
	_ "github.com/pmker/genv/pkg/processor/trigger/kinesis"
	_ "github.com/pmker/genv/pkg/processor/trigger/mqtt/basic"
	_ "github.com/pmker/genv/pkg/processor/trigger/mqtt/iotcore"
	_ "github.com/pmker/genv/pkg/processor/trigger/nats"
	_ "github.com/pmker/genv/pkg/processor/trigger/partitioned/eventhub"
	_ "github.com/pmker/genv/pkg/processor/trigger/partitioned/kafka"
	_ "github.com/pmker/genv/pkg/processor/trigger/partitioned/v3io"
	_ "github.com/pmker/genv/pkg/processor/trigger/poller/v3ioitempoller"
	_ "github.com/pmker/genv/pkg/processor/trigger/pubsub"
	_ "github.com/pmker/genv/pkg/processor/trigger/rabbitmq"
