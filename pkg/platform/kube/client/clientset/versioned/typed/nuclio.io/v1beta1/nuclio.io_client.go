...
import (
	...
	"github.com/pmker/genv/pkg/platform/kube/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*NuclioV1beta1Client, error) {
	...
	return &NuclioV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new NuclioV1beta1Client for the given config and
...
func New(c rest.Interface) *NuclioV1beta1Client {
	return &NuclioV1beta1Client{c}
}
